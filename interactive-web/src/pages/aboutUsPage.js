...
import { Layout, Row, Col, Avatar, Divider, Typography } from 'antd'
                ...
                <Row justify="center">
                    <Col xs={22} sm={20} md={16} lg={15} xl={15} xxl={15}>
                        <Row justify="center" align="middle">
                            <Col span={24}>
                                <h1 className="h1top" style={{ paddingTop: '64px' }}>Our team</h1>
                            </Col>
                        ...
                        <p style={{ fontSize: '20px', lineHeight: '40px', textAlign: 'justify' }}>
                            ...
                            passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the standard dummy text ever since the 1500s,
                            when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap
                            into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum
